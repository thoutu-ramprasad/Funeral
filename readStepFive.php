...
<div class="la-pagination la-display-m mb-5">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="pl-0 border-0">
                                                        <span class="text-inverse f-18 l-28 azure-blue"><?php echo isset($planname) ? $planname : ''; ?></span>
                                                        <br/>
 ...
 <script>
    $(document).ready(function(){
        ...
        $('input[name="tandc"]').click(function(){
            if($(this).prop("checked") == true){
            }else{
              $(".error_checkbox").html("");
              $(".error_checkbox").html("Please check the terms and conditions.").css('color', 'red');
            }
    });});
</script>