                                ...
                                <div class="col-sm-8">
                                 <p class="f-16 blue-gray mt-5 l-23 mb-0">You and your family will get</p>
                                    ...
                                    if(isset($_SESSION['json_data_family'])){
                                      ...
                                      for($i=0;$i< $json_data_family_count; $i++){
...
<form method="post" id="family-plan">
<div class="input_fields_wrap"></div>
                                ...
                                <div class="col-md-4 la-display-d">
                                        <div class="pad bg-blue-gredient p-20 border-5x">
                                        <h2 class="text-left f-22 l-36 mb-15">Your policy summary</h2>
                                        <div class="bg-gray pl-20 pt-10 pb-2 mb-20">
...
<h2 class="text-left f-24 l-36 ls-minus-2 color-white res-summary"> 
	<button type="button" class="p-0 text-left f-22 l-36 ls-minus-2 color-white res-summary btn btn-link text-decoration-none" data-toggle="collapse" data-target="#collapseTwo" style="text-decoration:none;">Your policy summary</button>
</h2>
</div>
...
<script>
  ...
  var quoteform = $('#family-plan').serializeArray();
