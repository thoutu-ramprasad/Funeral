...
<div class="la-display-d">
                                        ...
                                        <h2 class="text-left f-22 l-36 mb-15" style="font-size:1.7vw;">Your policy summary</h2>
                                        <div class="bg-gray pl-20 pt-10 pb-2 mb-20">
                                            <label class="color-white f-30 l-50 ls-0-56 font-strong la-total-monthly-payment"><?php echo isset($finalpremiumamountwithcountry) ? $finalpremiumamountwithcountry : $premium; ?></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="f-12 lh-15 family-strong uppercase mb-0 la-benefit-amount">Basic premium</p>
                                            </div>
                                            <div class="col-sm-5 text-right la-premium-amt">
                                            <label class="f-14 lh-28 ls-0-21 color-white family-strong la-benefit-amount1"><?php echo $premium; ?></label>
                                            </div>
                                        </div>
                                        <hr class="border-white-top">
                                        <p class="uppercase f-12 lh-15 family-strong mb-0 la-benefit-amount">Benefit amount</p>
                                        <label class="f-37 lh-54 font-strong color-white" style="font-size:2.5vw;"><?php echo $benfitamount; ?></label>
										<div class="loaddata"></div>
                                  <a href="javascript:void(0)" class="genric-btn after callme-back info bold-letters get-a-quote width-full color-white bg-bright-blue mt-3  uppercase ml-0 la-call-me-back">call me back</a>
...
<h2 class="text-left f-24 l-36 ls-minus-2 color-white res-summary"> 
	<button type="button" class="p-0 text-left f-22 l-36 ls-minus-2 color-white res-summary btn btn-link text-decoration-none" data-toggle="collapse" data-target="#collapseOne" style="text-decoration:none;">Your policy summary</button>
</h2>
</div>
                ...
                <div class="col-12 text-left card-body p-1">
                    <p>
						<div class="col-12 bg-gray pl-30 pt-10 pb-2 mb-20 text-left">
                                  ...
                                  <div class="loaddata"></div>
                                  <a href="javascript:void(0)" class="genric-btn callme-back info bold-letters get-a-quote width-full azure-blue bg-white mt-3 pt-10 pb-10 uppercase" >give me a call</a>
