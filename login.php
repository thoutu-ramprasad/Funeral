...
$_SESSION['token'] = base64_encode("$username:$pwd");
include('apiGetThisClient.php');
?>
                                        ...
                                        <div class="row">	
                                         ...
                                         <div class="single_input">
                                                        <div class="mt-10 wide position-relative">
                                                            <label class="left f-12 l-17 m-0 color-grey mt-4" for="username">Username</label><input type="text" name="username" id="username" autocomplete="off" placeholder="Enter username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter username'"  class="single-input p-0 transparent-input">
                                                        ...
                                                        <div class="mt-10 wide position-relative">
                                                            <label class="left f-12 l-17 m-0 color-grey mt-4" for="password">Password<span style="position: absolute;right:0;
                                                                bottom: 40px;" class='f-14 l-20'><a class="color-grey" href="forgot_password">Forgot password?</a></span>
																 <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password" style="position: absolute;
                                                                right: 10px;
                                                                bottom: 10px;"></span> 
                                                                </label><input type="password" id="password-field" name="password" id="password" autocomplete="off" placeholder="Enter password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter password'"  class="single-input p-0 transparent-input eyec ">
                                                                <div class="error_paswd"></div>
                                                                           
                                                        </div>
                                                       
                                                        <?php if(isset($_POST['submit'])){?>
                                    <span class="color-red w-100 mt-5 failedresponse"><?php echo $jsonresponse; ?></span>
                                    <?php } ?>
                                        ...
                                        <div class="button-group-area mt-3 w-100">
                                            ...
                                            <input type="submit" name="submit" class="login-submit genric-btn success-border large w-30 bg-azure-blue nextBtn color-white font-strong border-3x mb-3 uppercase" value="Login"/>
                                        </div> 
