...
.message,
.hidden {
  font-family: 'Telkom123-Bold', serif;
  font-size: 18px;
}
...
<section class="centered">
  <h1><?php echo $_GET['code']; ?> Server Error</h1>
  <div class="container">
  ...
  <a href="./" class="genric-btn info bold-letters get-a-quote">Back to home</a>
</div>
</section>

      <script src="js/vendor/jquery-1.12.4.min.js"></script> 
 <script>// Here are the different messages we'll use for creating the 500 displayable message
const messages = [
